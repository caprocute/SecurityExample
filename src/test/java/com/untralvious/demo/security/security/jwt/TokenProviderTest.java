...
//
//        tokenProvider = new TokenProvider(jHipsterProperties, securityMetersService, sysUserRepository, sysRoleRepository);
...
//        SecurityMetersService securityMetersService = new SecurityMetersService(new SimpleMeterRegistry());
//
//        TokenProvider tokenProvider = new TokenProvider(jHipsterProperties, securityMetersService, sysUserRepository, sysRoleRepository);
//
