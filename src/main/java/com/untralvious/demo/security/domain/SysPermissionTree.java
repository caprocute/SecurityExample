...
public class SysPermissionTree implements Serializable {
    ...
    public SysPermissionTree(SysPermission permission) {
        ...
        this.isLeaf = permission.getIsLeaf() == 1;
        ...
        this.hidden = permission.getHidden() != null ? permission.getHidden() == 1 : false;
        this.route = permission.getIsRoute() != null ? permission.getIsRoute() == 1 : false;
        this.keepAlive = permission.getKeepAlive() != null ? permission.getKeepAlive() == 1 : false;
        this.alwaysShow= permission.getAlwaysShow() != null ? permission.getAlwaysShow() == 1 : false;
        this.internalOrExternal = permission.getInternalOrExternal() != null ? permission.getInternalOrExternal() == 1 : false;
        this.title=permission.getName();
        if (permission.getIsLeaf() != null && !(permission.getIsLeaf() == 1)) {
