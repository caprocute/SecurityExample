...
/**
 * REST controller for managing {@link com.untralvious.demo.security.domain.SysUserRole}.
 */
@RestController
@RequestMapping("/api")
public class SysUserRoleResource {
    ...
    public ResponseEntity<SysUserRoleDTO> updateSysUserRole(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sysUserRoleDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SysUserRoleDTO> partialUpdateSysUserRole(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, sysUserRoleDTO.getId().toString())
        );
    }
